                ...
                <div class="bg-white p-4 m-4 flex flex-col items-center">
                    <div class="flex flex-col items-center bg-white rounded-lg border shadow-md max-w-full dark:border-gray-700 dark:bg-gray-800 p-5">
                        ...
                        <div class="flex flex-col justify-between items-center p-4 leading-normal flex-grow">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ $doctor->getFullname() }}</h5>
                                        ...
                                        <div class="overflow-hidden shadow-md sm:rounded-lg">
                                            <table class="min-w-full">
                                                ...
                                                <tbody>
                                                    <tr class="bg-white dark:bg-gray-800 dark:border-gray-700">
                                                        <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                            {{ date('F d, Y', strtotime($doctor->dob)) }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                <thead class="bg-gray-50 dark:bg-gray-700">
                                                ...
                                                <tbody>
                                                    <tr class="bg-white dark:bg-gray-800 dark:border-gray-700">
                                                        <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                            {{ date('F d, Y - h:i a', strtotime($doctor->created_at)) }}
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                            ...
                            <div class="flex mt-4 space-x-3 lg:mt-6">
                                <form action="{{ route('admin.doctor.acc-status.toggle') }}" method="post">
                                    @csrf
